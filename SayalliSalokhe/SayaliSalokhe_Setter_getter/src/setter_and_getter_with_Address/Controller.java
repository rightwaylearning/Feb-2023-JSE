...
public class Controller {
	public static void main(String[] args) {
		...
		s.setAdr(a); // assing value to Student in Address class
		...
		/*
		 * String Line1 = a.getLine1(); String Line2 = a.getLine2(); int pinCode =
		 * a.getPin_Code(); s.getAdr(); Address adr = a;
		 * 
		 */
		Address adr1 = s.getAdr();
		System.out.println(roll_No);
		System.out.println(name);
		System.out.println(adr1.getLine1());
		System.out.println(adr1.getLine2());
		System.out.println(adr1.getPin_Code());
